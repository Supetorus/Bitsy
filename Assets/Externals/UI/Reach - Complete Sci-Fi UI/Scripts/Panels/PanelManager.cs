...
namespace Michsky.UI.Reach
{
    public class PanelManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (panelMode == PanelMode.MainPanel) { cachedStateLength = ReachInternalTools.GetAnimatorClipLength(panels[currentPanelIndex].panelObject, "MainPanel_In"); }
            else if (panelMode == PanelMode.SubPanel) { cachedStateLength = ReachInternalTools.GetAnimatorClipLength(panels[currentPanelIndex].panelObject, "SubPanel_In"); }
