...
namespace Michsky.UI.Reach
{
    ...
    public class QuestItem : MonoBehaviour
    {
        ...
        [Range(0, 30)] public float minimizeAfter = 5;
        ...
        {
            yield return new WaitForSeconds(ReachInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_In"));
            questAnimator.enabled = false;
        }

        IEnumerator DisableItem()
        {
            yield return new WaitForSeconds(ReachInternalTools.GetAnimatorClipLength(questAnimator, "QuestItem_Out"));
