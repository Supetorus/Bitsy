...
namespace Michsky.UI.Reach
{
    ...
    public class HorizontalSelector : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            cachedStateLength = ReachInternalTools.GetAnimatorClipLength(selectorAnimator, "HorizontalSelector_Next");
        }
        ...
        public void InitializeSelector()
        {
            ...
            if (useLocalization == true)
            {
                ...
                if (localizedObject == null || (localizedObject.localizationManager != null && localizedObject.localizationManager.UIManagerAsset.enableLocalization == false)) { useLocalization = false; }
