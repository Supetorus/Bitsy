Shader "Unreal/MAT_PolygonSciFiSpace_Space_Planets"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[6] = float4(100000.000000,0.000010,6.763224,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(-43444921371021878048095012254646272000.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-14783341299861611280254552781094912.000000,0.000000,-359239863084859650696282112.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local33 = MaterialStoreTexCoordScale(Parameters, Local32, 2);
	MaterialFloat4 Local34 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,Local32,View.MaterialTextureMipBias));
