Shader "Unreal/MAT_PolygonSciFiSpace_Hud"
{
	Properties
	{
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = lerp(MaterialFloat3(0.00000000,0.86449790,1.00000000),Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
