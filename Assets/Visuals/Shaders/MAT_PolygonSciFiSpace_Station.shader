Shader "Unreal/MAT_PolygonSciFiSpace_Station"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_PolygonSciFiSpace_Emissive_01", 2D ) = "white" {}
		Material_Texture2D_1( "ShipDetail", 2D ) = "white" {}
		Material_Texture2D_2( "Base_Texture", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.852480,0.136735,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(5.000000,0.852480,0.136735,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(-43428695443338956711755854453617459200.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(-43449789149326754448996759594954915840.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(-43427072850570664578121938673514577920.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local11 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,DERIV_BASE_VALUE(Local9),View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 0);
	MaterialFloat3 Local13 = (Local8 + Local11.rgb);
	MaterialFloat3 Local14 = lerp(Local13,Material.PreshaderBuffer[3].yzw,Material.PreshaderBuffer[3].x);
	MaterialFloat2 Local15 = Parameters.TexCoords[2].xy;
	MaterialFloat2 Local16 = (DERIV_BASE_VALUE(Local15) * ((MaterialFloat2)Material.PreshaderBuffer[4].x));
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 2);
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local16),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 2);
	MaterialFloat3 Local20 = lerp(((MaterialFloat3)0.00000000),Local18.rgb,Material.PreshaderBuffer[4].y);
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local9), 1);
	MaterialFloat4 Local22 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local9),View.MaterialTextureMipBias));
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 1);
	MaterialFloat3 Local24 = (Local20 * Local22.rgb);
	...
	PixelMaterialInputs.Roughness = 0.60000002;
