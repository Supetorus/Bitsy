Shader "Unreal/MAT_FX_Booster_Mat"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_PolygonSciFiSpace_Gradient_Boost", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(-43430318036107248845389770233720340480.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local4 = (Local2.rgb * MaterialFloat3(0.09566800,0.63075298,1.00000000));
