Shader "Unreal/MAT_FX_Skybox"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_TextureCube_0( "T_PolygonSciFiSpace_Skybox_01", Cube ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(-43451411742095046582630675375057797120.000000,0.000000,-359239863084859650696282112.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local2 = ProcessMaterialColorTextureLookup(TextureCubeSample(Material_TextureCube_0,Material_TextureCube_0Sampler,Local0));
