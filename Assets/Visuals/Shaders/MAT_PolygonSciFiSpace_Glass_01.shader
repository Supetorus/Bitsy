Shader "Unreal/MAT_PolygonSciFiSpace_Glass_01"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_PolygonSciFiSpace_01_A", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(-43427072850570664578121938673514577920.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = lerp(MaterialFloat3(0.26015800,0.44141001,0.45500001),Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
