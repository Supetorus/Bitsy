Shader "Unreal/MAT_FX_Warptunnel_Mat"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_PolygonSciFiSpace_WindTrail", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(-43435185814412125246291517574028984320.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local4 = (((MaterialFloat3)Local2.a) * Parameters.Particle.Color.rgb);
	...
	PixelMaterialInputs.Opacity = Parameters.Particle.Color.a;
