Shader "Unreal/MAT_PolygonSciFiSpace_Energy"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(-43428695443338956711755854453617459200.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Opacity = 0.80000001;
