Shader "Unreal/MAT_PolygonSciFiSpace_Signs_01_A"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_PolygonSciFiSpace_Signs_Emissive_01", 2D ) = "white" {}
		Material_Texture2D_1( "T_PolygonSciFiSpace__Signs_01_A", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(-43438430999948709513559349134234746880.000000,0.000000,-14783341299861611280254552781094912.000000,0.000000);//(Unknown)
